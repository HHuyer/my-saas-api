...
/**
 * Login page — OAuth buttons when configured, otherwise test-login form.
 */
export default function Login() {
  ...
  const hasGitHubOAuth = Boolean(import.meta.env.VITE_GITHUB_CLIENT_ID);
    ...
    <div className="auth-screen">
      <div className="auth-card">
        ...
        <p className="auth-hint">
          {hasGoogleOAuth || hasGitHubOAuth
            ? 'Development demo — use OAuth or the test form below.'
            : 'Development demo — any valid email creates an account.'}
        </p>
      </div>
    </div>
  );
